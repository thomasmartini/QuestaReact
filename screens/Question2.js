...
import { Text, TextInput, View, StyleSheet, Image, TouchableOpacity, ScrollView, Alert, Button } from 'react-native';
        ...
        <ScrollView contentContainerStyle={styles.ScrollView}>
            <View style={styles.questionBackground}>
                ...
                <Text style={styles.questionBody}>
                    Hoe was je ervaring van de entree van Rotterdam Centraal?
                </Text>
            </View>
